...
void cfb8encrypt(unsigned char *raw_data, size_t raw_data_len,
    ...
    mbedtls_aes_crypt_cfb8(&aes, MBEDTLS_AES_ENCRYPT, raw_data_len, iv,
                           raw_data, encrypted_output);
    encryptTime = esp_timer_get_time();
#endif
}

void cfb8decrypt(unsigned char *encrypted_data, size_t encrypted_data_len,
